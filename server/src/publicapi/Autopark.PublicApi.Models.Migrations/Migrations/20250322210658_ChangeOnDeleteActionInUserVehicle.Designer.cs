...
namespace Autopark.PublicApi.Models.Migrations.Migrations
{
    ...
    [Migration("20250322210658_ChangeOnDeleteActionInUserVehicle")]
    partial class ChangeOnDeleteActionInUserVehicle
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Autopark.PublicApi.Models.Users.User", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Autopark.PublicApi.Models.Permissions.Permission", b =>
                {
                    b.HasOne("Autopark.PublicApi.Models.Vehicles.Vehicle", "Vehicle")
                        .WithOne("Permission")
                        .HasForeignKey("Autopark.PublicApi.Models.Permissions.Permission", "VehicleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Autopark.PublicApi.Models.Vehicles.Vehicle", b =>
                {
                    b.HasOne("Autopark.PublicApi.Models.Users.User", "User")
                        .WithMany("Vehicles")
